...
So until 2012 and 2013 I'd say that we were in the golden age of #dataviz in terms of discovereries and chartering new paths: excited comments on new productions by the NYT, debates around the goals of #dataviz: is it a way to tell stories? To open new worlds? To educate? New connections made with new comers, new agencies, people meeting for the first time in conferences after exchanging on Twitter for years, new positions, big clients...
...
To illustrate possible paths, I like to give the example of the career of Seb Lee Deslile, who defined himself as a creative coder and now as as a digital artist. I follow his work on Twitter since about 2009. He is at the heart of the "dataviz" network but you'd find him on Jeff Clark's map of dataviz in 2012 nonetheless.  

- so, he was using Adobe Flash as one of his main technologies until 2009, contributing to PaperVision3D, a framework to build 3D scences run in the Flash Player.  
...
in in 2014/2015, he launches workshops on "Stuff that talk to the Internets"

This path, and realizations by others, suggest that:

1. The screen or the flat surface is becoming just one of the ways data can be visualized. Objects, sculptures, buildings, furniture... this is the next frontier to be explored. Not just mapping data on a screen, but actual construction of data objects.     
...
3. And "data" gets an even larger meaning. I mean, I was happy to move from a tabular notion of data to "unstructured text": like wow, that opens wild possibilities! But when you move away from the screen and start connecting to a variety of ojbects and with a variety of people, data will takes still other forms: real time measurements from the external physical environment, from the internal (body) environment, from local or distant social interactions as they unfold, ...
...
This is just a vision, I'd be happy to discuss it with you now!
